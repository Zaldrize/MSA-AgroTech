...
| ------------------------------------------------------------ | ----------------------------------------------------------------- | ------ | --------------- |
| Каждое edge-устройство отправляет уведомление самостоятельно | Независимость друг от друга;                                      |
| может быть проще для MVP                                     | Нарушает чистоту архитектуры; тяжелее добавлять новые устройства; |
| тяжелее тестировать                                          |                                                                   |
